...
mutation InitiateSearch {
  initiateSearch(
    query: "I need a good hospital for cardiac surgery"
    customerId: "test-user-123"
    userLocation: {
      latitude: 17.385044
      longitude: 78.486671
...
query GetSearchResults {
  getSearchResults(searchId: "search_1772936172_Z4dM5jSCIAMEJWw=") {
    searchId
    status
    results {
      aiSummary
...
subscription OnAgentActivity {
  onAgentActivity(searchId: "search_1772936172_Z4dM5jSCIAMEJWw=") {
    searchId
    chunk
    timestamp
  }
